                ...
                <div class="max-w-2xl py-4 mx-auto">
                    ...
                    <form method="POST" action="{{ route('events.store') }}">
                        ...
                        <div>
                            ...
                            <x-jet-input id="event_name" class="block mt-1 w-full" type="text" name="event_name" :value="old('event_name')" required autofocus autocomplete="name" />
                        </div>
                        ...
                        <div class="md:flex justify-between">
                            ...
                            <div class="mt-4">
                                ...
                                <x-jet-input id="end_time" class="block mt-1 w-full" type="text" name="end_time" required autocomplete="new-password" />
                            </div>
